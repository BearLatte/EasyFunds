...
struct Product : Decodable, Identifiable {
    ...
    init(from decoder: Decoder) throws {
        ...
        productDays = try values.decodeIfPresent(String.self, forKey: .productDays)
        productAmount = try values.decodeIfPresent(String.self, forKey: .productAmount)
        productRate = try values.decodeIfPresent(String.self, forKey: .productRate)
        loanAmount = try values.decodeIfPresent(String.self, forKey: .loanAmount)
        loanOfDays = try values.decodeIfPresent(String.self, forKey: .loanOfDays)
        loanPayAmount = try values.decodeIfPresent(String.self, forKey: .loanPayAmount)
        loanFeeVerify = try values.decodeIfPresent(String.self, forKey: .loanFeeVerify)
        loanFeeGst = try values.decodeIfPresent(String.self, forKey: .loanFeeGst)
        loanInterest = try values.decodeIfPresent(String.self, forKey: .loanInterest)
        loanOverdue = try values.decodeIfPresent(String.self, forKey: .loanOverdue)
        loanRepayAmount = try values.decodeIfPresent(String.self, forKey: .loanRepayAmount)
    }
